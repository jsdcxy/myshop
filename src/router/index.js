...
export default new Router({
  ...
  routes: [{
    ...
    },
    {
      ...
      component: () =>
        import ('@/pages/information/index.vue')
    },
    {
      path: '/commodity/:category',
      name: 'product-commodity-category',
      component: () =>
        import ('@/pages/commodity/index.vue')
    },
    {
      path: '/cart',
      name: 'cart-list',
      component: () =>
        import ('@/pages/cart/index.vue')
    },
    {
      path: '/me',
      name: 'shop-me',
    ...
    },
    {
      ...
      name: 'shop-person',
      component: () =>
        import ('@/pages/person/index.vue')
    },
    {
      path: '/articles',
      name: 'shop-articles',
      component: () =>
        import ('@/pages/articles/index.vue')
    },
    {
